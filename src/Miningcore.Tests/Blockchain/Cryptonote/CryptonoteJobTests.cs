...
namespace Miningcore.Tests.Blockchain.Cryptonote
{
    public class CryptonoteJobTests : TestBase
    {
        ...
        public void MoneroJob_PrepareWorkerJob()
        {
            ...
            var bt = JsonConvert.DeserializeObject<Miningcore.Blockchain.Cryptonote.DaemonResponses.CryptonoteBlockResponse>(
            ...
            var workerJob = new CryptonoteWorkerJob(1.ToString(), 10000);
            job.PrepareWorkerJob(workerJob, out var blob, out var target);

            Assert.Equal(blob, "0106e7eabdcf058234351e2e6ea901a56b33bb531587424321873072d80a9e97295b6c43152b9d00000000b7dff217012da3129b6e6a4b8705a598f8928469398b3479b711b6ceee16072301");
            Assert.Equal(target, "b88d0600");
        }
